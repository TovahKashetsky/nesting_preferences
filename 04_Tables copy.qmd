  ...
  df %>%
    mutate(
      Variable = dplyr::recode(Variable,
                               ...
                               'Cell_parasitized' = 'Cell parasitism',
                               'Nest_parasitizedparasitized' = 'Nest parasitism (parasitized)',
                               'scale(DP_os_prior):Nest_parasitizedparasitized' = 'Number of host nests with detectable parasites * Nest parasitism (parasitized)',
                               'scale(DP_meg_prior):Nest_parasitizedparasitized' = 'Neighbouring host nests with detectable parasites * Nest parasitism (parasitized)',
                               'poly(Day_of_year, 2)1' = 'Day of year I',
                               'poly(Day_of_year, 2)2' = 'Day of year II',
                               'Yearyear_2024' = 'Year (2024)',
                               'SiteCP' = 'Site (CP)',
...
mod_3di_inner_wall_os_table <- tidy_function_glmer(mod_3di_inner_wall_os) %>%
  format_table_function_glmer %>% 
  format_table_function_terms()
# mod_3dii_inner_wall_meg_table <- tidy_function_glmer(mod_3dii_inner_wall_meg) %>%
#  format_table_function_glmer %>% 
#  format_table_function_terms()
...
**Table S5.** GLMM input for prediction 1, model 1_i testing for an attraction to congenerics in nesting *Osmia*, including pseudo nests as congenerics, n = 161 nests.
...
**Table S7.** GLMM input for prediction 1, model 1_iii testing for an attraction to congenerics in nesting *Megachile*, including pseudo nests as congenerics, n = 137 nests.
...
**Table S9.** Summary of the GLMM output from model 2_i testing for an attraction to *Osmia* nests by parasites (*Sapyga*, *Melittobia*), including pseudo nests as *Osmia,* n = 286 cells. Asterisks indicate significance for the following tables.
...
**Table S10.** Summary of the GLMM output from model 2_ii for prediction 2, testing an attraction to *Osmia* nests by parasites (*Sapyga*, *Melittobia*), excluding pseudo nests as *Osmia*, n = 286 cells.
...
**Table S11.** Summary of the GLMM output from model 2_iii for prediction 2, testing an attraction to active *Osmia* nests by parasites (*Sapyga*, *Melittobia*), excluding pseudo nests as *Osmia,* n = 286 cells.
...
**Table S12.** Summary of the GLMM output from model 2_iv for prediction 2, testing an attraction to *Megachile* nests by parasites (meloid beetles, *Melittobia*, chalcid wasps, and *Coelioxys*), including pseudo nests as *Megachile*, n = 142 cells.
...
**Table S13.** Summary of the GLMM output from model 2_v for prediction 2, testing an attraction to *Megachile* nests by parasites (meloid beetles, *Melittobia*, chalcid wasps, and *Coelioxys*), excluding pseudo nests as *Megachile*, n = 142 cells.
...
**Table S14.** Summary of the GLMM output from model 2_vi for prediction 2, testing an attraction to active *Megachile* nests by parasites (meloid beetles, *Melittobia*, chalcid wasps, and *Coelioxys*), excluding pseudo nests as *Megachile*, n = 142 cells.
...
**Figure S8.** Coefficients from the *Osmia* GLMMs using simulated data (grey bars) and the GLMM using observed data (red line) from model 3a_ii, for effects of (A) or neighbouring congeneric nests with detectable parasites, (B) neighbouring congeneric nests with no detectable parasites (excluding pseudo nests), and C) the interaction between these two terms.
...
**Figure S9.** Coefficients from the *Megachile* GLMMs using simulated data (grey bars) and the GLMM using observed data (red line) from model 3a_iii, for effects of (A) or neighbouring congeneric nests with detectable parasites, (B) neighbouring congeneric nests with no detectable parasites (including pseudo nests), and C) the interaction between these two terms.
...
**Figure S10.** Interaction plots for the interaction from model 3a_iii between neighbouring congeneric nests with detectable parasites and nests with no detectable parasites (including pseudo nests) from the *Megachile* GLMM with (A) observed data and (B-F) five GLMMs conducted with random columns of the simulated data. Note the different y axes.

**Table S18.** Summary of the GLMM output from model 3b_i for prediction 3b, testing a change in nest investment of *Osmia* in response to parasitism, n = 74 nests.
...
**Table S19.** Summary of the GLMM output from model 3b_ii for prediction 3b, testing a change in nest investment of *Megachile* in response to parasitism, n = 40 nests.
...
**Table S20.** Summary of the GLMM output from model 3c_i for prediction 3c, testing if cell parasitization predicts nest termination in *Osmia*, n = 245 cells.
...
**Table S21.** Summary of the GLMM output from model 3c_ii for prediction 3c, testing if cell parasitization predicts nest termination in *Megachile*, n = 136 cells.
...
**Table S22.** Summary of the GLMM output from model 3d_i for prediction 3d, testing abandoning inner walls as a response to parasites in *Osmia*, n = 168 nests with 28 of these nests being abandoned inner walls.
...
# Table S23. Summary of the GLMM output from model 3d_i for prediction 3d, testing abandoning inner walls in response to parasites in Megachile.
