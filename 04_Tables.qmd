...
**Table S9.** Summary of the GLMM output from model 2_i testing for an attraction to *Osmia* nests of brood parasites (*Sapyga*, *Melittobia*), including pseudo nests as *Osmia*.
...
**Table S10.** Summary of the GLMM output from model 2_ii for prediction 2, testing an attraction to *Osmia* nests of brood parasites (*Sapyga*, *Melittobia*), excluding pseudo nests as *Osmia*.
...
mod_2ii_table <- font(mod_2ii_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE) 
# set width
mod_2ii_table <- mod_2ii_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.4, .8, .8, .8, 1.2))
# # bold rows with significant p-value
...
**Table S11.** Summary of the GLMM output from model 2_iii for prediction 2, testing an attraction to active *Osmia* nests of brood parasites (*Sapyga*, *Melittobia*), excluding pseudo nests as *Osmia*.
...
mod_2iii_table <- font(mod_2iii_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# set width
mod_2iii_table <- mod_2iii_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.4, .8, .8, .8, 1.2)) 
# # bold rows with significant p-value
...
**Table S12.** Summary of the GLMM output from model 2_iv for prediction 2, testing an attraction to *Megachile* in brood parasites (*Meloid*, *Melittobia*, *Chalcid*, and *Coelioxys*), including pseudo nests as *Megachile*.
...
mod_2iv_table <- font(mod_2iv_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# width
mod_2iv_table <- mod_2iv_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.4, .8, .8, .8, 1.2))
# # bold rows with significant p-value
...
**Table S13.** Summary of the GLMM output from model 2_v for prediction 2, testing an attraction to *Megachile* in brood parasites (*Meloid*, *Melittobia*, *Chalcid*, and *Coelioxys*), excluding pseudo nests as *Megachile*.
...
mod_2v_table <- font(mod_2v_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE) 
# make table take up full width of word doc
mod_2v_table <- mod_2v_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.4, .8, .8, .8, 1.2))
# # bold rows with significant p-value
...
**Table S14.** Summary of the GLMM output from model 2_vi for prediction 2, testing an attraction to active *Megachile* nests of brood parasites (*Meloid*, *Melittobia*, *Chalcid*, and *Coelioxys*), excluding pseudo nests as *Megachile*.
...
mod_2vi_table <- font(mod_2vi_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# make table take up full width of word doc
mod_2vi_table <- mod_2vi_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.4, .8, .8, .8, 1.2))
# # bold rows with significant p-value
...
mod_3bi_table <- font(mod_3bi_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# make table take up full width of word doc
mod_3bi_table <- mod_3bi_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "DF", "T Value", "P-Value"), width = c(.7, 2.4, .8, .65, .65, .65, 1.1))
# # bold rows with significant p-value
...
mod_3bii_table <- font(mod_3bii_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# make table take up full width of word doc
mod_3bii_table <- mod_3bii_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "DF", "T Value", "P-Value"), width = c(.7, 2.4, .8, .65, .65, .65, 1.1))
# # bold rows with significant p-value
...
mod_3ci_table <- font(mod_3ci_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# make table take up full width of word doc
mod_3ci_table <- mod_3ci_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.7, .8, .8, .8, 1.2))
# # bold rows with significant p-value
...
mod_3cii_table <- font(mod_3cii_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# make table take up full width of word doc
mod_3cii_table <- mod_3cii_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.7, .8, .8, .8, 1.2))
# # bold rows with significant p-value
...
mod_3di_table <- font(mod_3di_table, fontname = "Times New Roman", part = "all") %>%
  ...
  bold(part = "header", bold = TRUE)
# make table take up full width of word doc
mod_3di_table <- mod_3di_table %>% width(j = c("Effect", "Variable", "Estimate", "Std. Error", "Z Value", "P-Value"), width = c(.7, 2.7, .8, .8, .8, 1.2))
# # bold rows with significant p-value
