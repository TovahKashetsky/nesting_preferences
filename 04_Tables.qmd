...
subtitle: 'Supplementary Material: Statistics'
format:
  docx: 
  ...
  df %>%
    mutate(
      Variable = dplyr::recode(Variable,
                               ...
                               'Nest_parasitizedparasitized' = 'Nest parasitism (parasitised)',
                               'scale(DP_os_prior):Nest_parasitizedparasitized' = 'Number of neighbouring Osmia nests with detectable parasites * Nest parasitism (parasitised)',
                               'scale(DP_meg_prior):Nest_parasitizedparasitized' = 'Number of neighbouring congeneric nests with detectable parasites * Nest parasitism (parasitised)',
  ...
  df %>%
    mutate(
      Variable = dplyr::recode(Variable,
                               ...
                               'Cell_parasitized' = 'Cell parasitism',
                               'Nest_parasitizedparasitized' = 'Focal nest parasitism (parasitised)',
                               'scale(DP_os_prior):Nest_parasitizedparasitized' = 'Number of host nests with detectable parasites * Focal nest parasitism (parasitised)',
                               'scale(DP_meg_prior):Nest_parasitizedparasitized' = 'Number of neighbouring host nests with detectable parasites * Focal nest parasitism (parasitised)',
                               'poly(Day_of_year, 2)1' = 'Day of year I: linear effect',
                               'poly(Day_of_year, 2)2' = 'Day of year II: quadratic effect',
                               'Yearyear_2024' = 'Year (2024)',
                               'SiteCP' = 'Site (CP)',
...
**Table S13.** Summary of the binomial GLMM of *Osmia* cell parasitism status (0 for unparasitised, 1 for parasitised) for prediction 2, testing if parasites (*Sapyga*, *Melittobia*) are attracted to *Osmia* aggregations, including pseudo nests as hosts (model 2_i), n = 287 cells.
...
**Table S14.** Summary of the binomial GLMM of *Osmia* cell parasitism status (0 for unparasitised, 1 for parasitised) for prediction 2, testing if parasites (*Sapyga*, *Melittobia*) are attracted to *Osmia* aggregations, excluding pseudo nests as hosts (model 2_ii), n = 287 cells.
...
**Table S15.** Summary of the binomial GLMM of *Osmia* cell parasitism status (0 for unparasitised, 1 for parasitised) for prediction 2, testing if parasites (*Sapyga*, *Melittobia*) are attracted to active *Osmia* nests (model 2_iii), n = 287 cells.
...
**Table S16.** Summary of the binomial GLMM of *Megachile* cell parasitism status (0 for unparasitised, 1 for parasitised) for prediction 2, testing if parasites (*Coelioxys,* meloid beetles, *Melittobia*, and other chalcid wasps) are attracted to *Megachile* aggregations, including pseudo nests as hosts (model 2_iv), n = 142 cells.
...
**Table S17.** Summary of the binomial GLMM of *Megachile* cell parasitism status (0 for unparasitised, 1 for parasitised) for prediction 2, testing if parasites (*Coelioxys,* meloid beetles, *Melittobia*, and other chalcid wasps) are attracted to *Megachile* aggregations, excluding pseudo nests as hosts (model 2_v), n = 142 cells.
...
**Table S18.** Summary of the binomial GLMM of *Megachile* cell parasitism status (0 for unparasitised, 1 for parasitised) for prediction 2, testing if parasites (*Coelioxys,* meloid beetles, *Melittobia*, and other chalcid wasps) are attracted to active *Megachile* nests (model 2_vi), n = 142 cells.
