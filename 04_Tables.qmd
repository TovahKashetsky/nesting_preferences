...
subtitle: "Supplementary Material: GLMM Output"
format: 
  docx:
...
**Table S5.** Summary of the GLMM for model 1_i testing for an attraction to congenerics in nesting *Osmia*, including pseudo nests as congenerics.
...
**Figure S2.** Histogram of coefficients from the 100 models (model 1_i) using simulated data (grey bars) and the coefficient from the model using observed data (red line).

**Table S6.** Summary of the GLMM for model 1_ii testing for an attraction to congenerics in nesting *Osmia*, excluding pseudo nests as congenerics.
...
**Figure S3.** Histogram of coefficients from the 100 models (model 1_ii) using simulated data (grey bars) and the coefficient from the model using observed data (red line).

**Table S7.** Summary of the GLMM for model 1_iii testing for an attraction to congenerics in nesting *Megachile*, including pseudo nests as congenerics.
...
**Figure S4.** Histogram of coefficients from the 100 models (model 1_iii) using simulated data (grey bars) and the coefficient from the model using observed data (red line).

**Table S8.** Summary of the GLMM for model 1_iv testing for an attraction to congenerics in nesting *Megachile*, excluding pseudo nests as congenerics.
...
**Figure S5.** Histogram of coefficients from the 100 models (model 1_iv) using simulated data (grey bars) and the coefficient from the model using observed data (red line).
...
**Figure S6.** Histogram of coefficients from the 100 models (model 3_i) using simulated data (grey bars) and the coefficient from the model using observed data (red line).
...
**Figure S6.** Histogram of coefficients from the 100 models (model 3_ii) using simulated data (grey bars) and the coefficient from the model using observed data (red line).
...
**Figure S6.** Histogram of coefficients from the 100 models (model 3_iii) using simulated data (grey bars) and the coefficient from the model using observed data (red line).
