...
**Figure S9.** Interaction plots for the interaction between neighbouring congeneric nests with detectable parasites and nests with no detectable parasites (including pseudo nests) from the *Megachile* GLMM with A) observed data and B-F) five random columns of simulated data from model 3a_iii.
